...
export const updateCustomer =
  (id, custID, name, phone) => async (dispatch, getState) => {
    try {
      dispatch({
  ...
  async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        `/api/customers2?keyword2=${keyword2}&pageNumber=${pageNumber}`,
        config
      );
...
export const listCustomersByDateRange =
  (keyword2 = "", startDate, endDate) =>
  async (dispatch, getState) => {
    try {
      dispatch({ type: CUSTOMER_LIST_REQUEST });
      ...
      const { data } = await axios.post(
        `/api/customers2/date/range?keyword2=${keyword2}`,
        { startDate, endDate },
        config
      );
...
export const listMySales = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/customers2/mysales/${id}`, config);
...
export const listCustomerDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/customers2/${id}`, config);
...
export const deleteCustomer = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`/api/customers2/${id}`, config);
...
export const getCustomerTotal = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get("/api/customers2/total/customer", config);
