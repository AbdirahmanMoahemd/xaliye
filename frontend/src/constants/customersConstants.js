...
export const CUSTOMER_LIST_TOTAL_REQUEST = "CUSTOMER_LIST_TOTAL_REQUEST";
export const CUSTOMER_LIST_TOTAL_SUCCESS = "CUSTOMER_LIST_TOTAL_SUCCESS";
export const CUSTOMER_LIST_TOTAL_FAIL = "CUSTOMER_LIST_TOTAL_FAIL";
export const CUSTOMER_LIST_TOTAL_RESET = "CUSTOMER_LIST_TOTAL_RESET";
