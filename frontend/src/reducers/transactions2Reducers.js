import {
  ...
  export const createTransactionReducer2 = (state = {}, action) => {
    switch (action.type) {
  ...
  export const transactionsListReducer2 = (
  ...
  export const transactionDetailsReducer2 = (
    state = { transaction: {} },
    action
  ) => {
    switch (action.type) {
  ...
  export const transactionUpdateReducer2 = (
    state = { transaction: {} },
    action
  ) => {
    switch (action.type) {
  ...
  export const transactionDeleteReducer2 = (state = {}, action) => {
    switch (action.type) {
