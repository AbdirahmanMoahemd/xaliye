...
export const createStoreItemReducer2 = (state = {}, action) => {
  switch (action.type) {
...
export const storeItemListReducer2 = (state = { items: [] }, action) => {
  switch (action.type) {
...
export const storeItemDetailsReducer2 = (state = { item: {} }, action) => {
  switch (action.type) {
...
export const storeItemUpdateReducer2 = (state = { item: {} }, action) => {
  switch (action.type) {
...
export const storeItemDeleteReducer2 = (state = {}, action) => {
  switch (action.type) {
