...
import { createTask, createTaskExsting, deleteTaskById, getTaskById, getTasks, getTasksByPhone, getTasksByRange, getTasksByRecent, getTasksByThisWeek, getTasksInBin, getTotalTasks, moveTaskstoBin, restoreTasks, updateTasks, updateTasksStage } from '../controllers/tasksControllers.js'
...
router.route('/taskslist/byphone').get(protect, getTasksByPhone)
